...
new Material { Id = 56, Name = "外購電力", Scope = "範疇2", EmissionPattern = "其他電力", CO2CEF = 0.495F, CO2ULL = -0.07F, CO2UUL = 0.07F, CH4CEF = 0, CH4ULL = 0, CH4UUL = 0, N2OCEF = 0, N2OULL = 0, N2OUUL = 0, Unit = "" }
