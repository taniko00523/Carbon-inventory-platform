...
namespace Carbon_inventory_platform.Controllers
{
    public class MaterialsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Scope,EmissionPattern,CO2CEF,CO2ULL,CO2UUL,CH4CEF,CH4ULL,CH4UUL,N2OCEF,N2OULL,N2OUUL,HFCSCEF,HFCSULL,HFCSUUL,PFCSCEF,PFCSULL,PFCSUUL,SF6CEF,SF6ULL,NF3UUL,NF3CEF,NF3ULL,SF6UUL,CEF_Correction,DataUUL,DataULL,Year,Unit")] Material material)
        {
