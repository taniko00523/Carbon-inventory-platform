        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserLimitData = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmissionPattern = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmissionPattern = table.Column<string>(type: "TEXT", maxLength: 10, nullable: false),
                    Material = table.Column<string>(type: "TEXT", nullable: false),
                    Data_Correction = table.Column<int>(type: "INTEGER", nullable: false),
                    Device_Correction = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GWP_Year = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CEF_Correction = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EasyName = table.Column<string>(type: "TEXT", maxLength: 10, nullable: true),
                    EnglishName = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    EasyEnglishName = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    ContactName = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    Email = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    Phone = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    CompanyInformation = table.Column<string>(type: "TEXT", nullable: false),
                    AddressInformation = table.Column<string>(type: "TEXT", nullable: false),
                    ReportingInformation = table.Column<string>(type: "TEXT", nullable: false),
                    GHGInformation = table.Column<string>(type: "TEXT", nullable: false),
                    Scope1Information = table.Column<string>(type: "TEXT", nullable: false),
                    Scope2Information = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    District = table.Column<string>(type: "TEXT", maxLength: 10, nullable: false),
                    Address = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    FullAddress = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    Year = table.Column<int>(type: "INTEGER", nullable: false),
                    BaseYear = table.Column<bool>(type: "INTEGER", nullable: false),
                    Type = table.Column<string>(type: "TEXT", maxLength: 10, nullable: false),
                    OrganizationImagePath = table.Column<string>(type: "TEXT", nullable: true),
                    MapImagePath = table.Column<string>(type: "TEXT", nullable: true),
                    ShopDrawingsPath = table.Column<string>(type: "TEXT", nullable: true),
                    isDeleted = table.Column<byte>(type: "INTEGER", nullable: false),
                    CreateTime = table.Column<DateTime>(type: "TEXT", nullable: false),
                    ModifiedTime = table.Column<DateTime>(type: "TEXT", nullable: true),
                    DeleteTime = table.Column<DateTime>(type: "TEXT", nullable: true),
                    ...
                    no1_Grade = table.Column<int>(type: "INTEGER", nullable: false),
                    no2_Grade = table.Column<int>(type: "INTEGER", nullable: false),
                    no3_Grade = table.Column<int>(type: "INTEGER", nullable: false),
                    avg_Grade = table.Column<float>(type: "REAL", nullable: false),
                    all_Grade = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    OtherName = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    Scope = table.Column<string>(type: "TEXT", maxLength: 10, nullable: false),
                    EmissionPattern = table.Column<string>(type: "TEXT", maxLength: 10, nullable: false),
                    Material = table.Column<string>(type: "TEXT", nullable: false),
                    Customize = table.Column<bool>(type: "INTEGER", nullable: false),
                    AssetNo = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    Provess = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    Source = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    Dept = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
