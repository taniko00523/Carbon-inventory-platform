...
namespace Carbon_inventory_platform.Migrations
{
    ...
    public partial class _001 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "deviceDatas",
                columns: new[] { "Id", "Correction", "EmissionPattern", "Level", "Material", "Name", "Scope", "unit" },
                values: new object[,]
                {
                    { 1, 3, "逸散", 3, "R-410A", "冷氣機", "類別一", "公斤" },
                    { 2, 3, "逸散", 3, "R-134A", "冰水主機", "類別一", "公斤" },
                    { 3, 3, "逸散", 3, "R-134A", "冰箱", "類別一", "公斤" },
                    { 4, 3, "逸散", 3, "R-134A", "飲水機", "類別一", "公斤" },
                    { 5, 3, "逸散", 3, "R-134A", "乾燥機", "類別一", "公斤" },
                    { 6, 3, "逸散", 3, "R-134A", "車用空調", "類別一", "公斤" },
                    { 7, 3, "逸散", 3, "R-134A", "工業冷藏、冷凍", "類別一", "公斤" },
                    { 8, 3, "固定", 3, "柴油", "緊急發電機", "類別一", "公升" },
                    { 9, 2, "固定", 2, "液化石油氣", "廚房", "類別一", "公斤" },
                    { 10, 2, "移動", 2, "車用汽油", "公務車", "類別一", "公升" },
                    { 11, 2, "移動", 2, "柴油", "堆高機", "類別一", "公升" },
                    { 12, 3, "逸散", 3, "二氧化碳", "CO2滅火器", "類別一", "公斤" },
                    { 13, 3, "逸散", 3, "二氧化碳", "二氧化碳", "類別一", "公斤" },
                    { 14, 3, "逸散", 3, "二氧化碳", "WD40", "類別一", "公斤" },
                    { 15, 3, "逸散", 3, "海龍-1211", "海龍1211", "類別一", "公斤" },
                    { 16, 3, "逸散", 3, "FM200", "FM200", "類別一", "公斤" },
                    { 17, 3, "逸散", 3, "廢水處理", "化糞池", "類別一", "人" },
                    { 18, 1, "外購電力", 1, "外購電力", "電力", "類別二", "度" },
                    { 19, 3, "製程", 3, "乙炔", "乙炔", "類別一", "公斤" },
                    { 20, 3, "製程", 3, "焊條", "焊條", "類別一", "公斤" },
                    { 21, 3, "逸散", 3, "R-134A", "工業冷藏、冷凍", "類別一", "公斤" },
                    { 22, 3, "逸散", 3, "R-134A", "商用冰箱", "類別一", "公斤" },
                    { 23, 3, "逸散", 3, "R-134A", "中、大型冰箱", "類別一", "公斤" },
                    { 24, 3, "逸散", 3, "R-134A", "低溫冷凍車", "類別一", "公斤" },
                    { 25, 3, "逸散", 3, "R-134A", "食品加工冷藏、冷凍", "類別一", "公斤" },
                    { 26, 3, "製程", 3, "丁烷", "瓦斯罐", "類別一", "公斤" }
                });
